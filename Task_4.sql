DROP DATABASE IF EXISTS lesson_4hw;
CREATE DATABASE lesson_4hw;
USE lesson_4hw;
...
SELECT auto_mark.MARK, count(auto_regnum.REGNUM)
  FROM (
	SELECT DISTINCT MARK 
    FROM auto
    ) auto_mark
  LEFT JOIN auto auto_regnum
    ON auto_mark.MARK <> auto_regnum.MARK
 GROUP BY auto_mark.MARK;
